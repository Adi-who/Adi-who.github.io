...
export function XIcon({ size = 16, className }: IconProps) {
  return (
    <svg
      ...
      className={className}
    >
      <path d="M13.682 10.622 20.24 3h-1.554l-5.693 6.618L8.445 3H3.5l6.876 10.007L3.5 21h1.554l6.012-6.989L15.555 21H20.5l-6.818-10.378Zm-2.128 2.473-.697-.997L5.614 4.17h2.387l4.473 6.4.697.996 5.885 8.417h-2.387l-4.115-5.888Z" />
    </svg>
  )
}
